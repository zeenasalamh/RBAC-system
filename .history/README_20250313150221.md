...
composer require darkaonline/l5-swagger    # For API documentation
```
...
2. create DB using the command "CREATE DATABASE rbac;"
3. change the DB Name in .env file to "DB_DATABASE=rbac" 
